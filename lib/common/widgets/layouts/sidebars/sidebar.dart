import 'package:e_commerce_admin_panel/common/widgets/images/t_circular_image.dart';
import 'package:e_commerce_admin_panel/common/widgets/layouts/sidebars/menu/menu_item.dart';
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Menu Items
                    const TMenuItem(route: TRoutes.categories, icon: Iconsax.status, itemName: 'Dashboard'),
                    const TMenuItem(route: TRoutes.brands, icon: Iconsax.image, itemName: 'Media'),
