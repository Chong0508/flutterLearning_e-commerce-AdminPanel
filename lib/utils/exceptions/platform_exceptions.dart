  ...
  String get message {
    switch (code) {
      case 'INVALID_LOGIN_CREDENTIALS':
        return 'Invalid login credentials provided. Please double check your information.';
      case 'too-many-request':
        return 'Too many requests. Please try again later.';
      case 'invalid-arguement':
        return 'Invalid arguement provided to the authentication method.';
      ...
      case 'invalid-verification-code':
        return 'The provided verification code is invalid. Please enter a valid code';
      default:
