...
class TFormatException implements Exception {
  ...
  /// Create a format exception form a specific error code.
  factory TFormatException.fromCode(String code) {
    switch (code) {
      case 'invalid-email-format':
        return const TFormatException('The email address format is invalid. Please enter a valid email address.');
